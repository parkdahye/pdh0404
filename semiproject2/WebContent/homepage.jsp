...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div
		...
		<img src="img/pk6_logo.jpg" alt="Me" class="w3-image w3-padding-32"
		...
		<div class="w3-content w3-justify" style="max-width: 600px">
			...
			<p>
				바이핸드는 핸드메이드 상품을 뜻하는 'by hand'와 핸드메이드 상품을 구매한다는 'buy hand'의 뜻으로 PK-6에
				의해 고안된 소비자와 생산자를 잇는 직거래 마켓입니다.<br> 유니크한 아이템을 지금 바로 구매하세요!
			</p>
